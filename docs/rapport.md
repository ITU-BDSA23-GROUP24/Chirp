...
## License
After some consideration, we decided to use the “GNU General Public License”, Version 3, which is an open source, “copyleft” license. Most importantly, this means that:
