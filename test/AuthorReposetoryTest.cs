...
public class AuthorRepositoryTest{
    ...
    public static ChirpDBContext BasicDatabaseInitializer(){
        ...
        using (IServiceScope scope = app.Services.CreateScope())
        {
            ...
            ChirpDBContext testContext = services.GetRequiredService<ChirpDBContext>();
            ...
            testContext.Authors.AddRange(authors);
            testContext.Cheeps.AddRange(cheeps);
